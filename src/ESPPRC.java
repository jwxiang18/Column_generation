...
//        routes = new PriorityQueue<>(new Comparator<Route>() {
//            @Override
//            public int compare(Route o1, Route o2) {
//                return o1.sigma > o2.sigma ? 1 : -1;
//            }
//        });
    ...
    public List<Route> main(List<Route> Allroutes){
        routes.push(new Route(instance));
        addRoutes = new LinkedList<>();

        //增加停止的条件
        while(!routes.isEmpty() && candidateRoutes.get(instance.numOrders+1).size() <100){
            searchNextPoint(routes.pop());
        }
